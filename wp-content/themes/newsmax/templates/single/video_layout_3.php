 ...
 */
if ( ! function_exists( 'newsmax_ruby_render_single_post_video_layout_3' ) ) {
	function newsmax_ruby_render_single_post_video_layout_3() {
		...
		$class_name       = 'single-post-wrap single-post-1 single-post-video-3 is-single-' . esc_attr( $header_position );
		...
		//render breadcrumb
		$str .= '<div class="single-post-top is-dark-bg is-light-text clearfix">';
		...
		//single related box
		$str .= '<div class="single-post-top-video-related">';
