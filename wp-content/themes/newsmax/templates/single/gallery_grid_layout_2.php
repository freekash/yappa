 ...
 *
 * @return string
 * render single post gallery grid 2
 */
if ( ! function_exists( 'newsmax_ruby_render_single_post_gallery_grid_layout_2' ) ) {
	function newsmax_ruby_render_single_post_gallery_grid_layout_2( $param = array() ) {
		...
		$class_name       = 'single-post-wrap single-post-1 single-post-gallery-grid-2 is-single-' . esc_attr( $header_position );
