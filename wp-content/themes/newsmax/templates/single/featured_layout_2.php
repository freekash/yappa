 ...
 *
 * @return string
 * render single featured post layout 2
 */
if ( ! function_exists( 'newsmax_ruby_render_single_post_featured_layout_2' ) ) {
	function newsmax_ruby_render_single_post_featured_layout_2( $param = array() ) {
		...
		$class_name       = 'single-post-wrap single-post-2 is-single-' . esc_attr( $header_position );
		...
		$str .= newsmax_ruby_single_post_meta_info();
		$str .= newsmax_ruby_single_post_thumb_classic( $param );
