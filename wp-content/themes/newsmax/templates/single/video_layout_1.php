 ...
 */
if ( ! function_exists( 'newsmax_ruby_render_single_post_video_layout_1' ) ) {
	function newsmax_ruby_render_single_post_video_layout_1() {
		...
		$class_name       = 'single-post-wrap single-post-1 single-post-video-1 is-single-' . esc_attr( $header_position );
		...
		//video iframe as thumbnail
		$str .= '<div class="single-post-video-holder">';
		$str .= newsmax_ruby_single_post_video_classic();
		$str .= newsmax_ruby_single_post_video_related( $sidebar_position );
		$str .= '</div>';
