 ...
 *
 * @return string
 * render single post featured layout 8
 */
if ( ! function_exists( 'newsmax_ruby_render_single_post_featured_layout_8' ) ) {
	function newsmax_ruby_render_single_post_featured_layout_8( $param = array() ) {
		...
		$class_name       = 'single-post-wrap single-post-1 single-post-8 is-single-' . esc_attr( $header_position );
