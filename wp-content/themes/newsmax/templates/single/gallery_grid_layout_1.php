 ...
 *
 * @return string
 * render single post gallery grid 1
 */
if ( ! function_exists( 'newsmax_ruby_render_single_post_gallery_grid_layout_1' ) ) {
	function newsmax_ruby_render_single_post_gallery_grid_layout_1( $param = array() ) {
		...
		$class_name       = 'single-post-wrap single-post-1 single-post-gallery-grid-1 is-single-' . esc_attr( $header_position );
		...
		$str .= newsmax_ruby_single_post_thumb_gallery_grid();
