 ...
 *
 * @return string
 * render single post featured layout 1
 */
if ( ! function_exists( 'newsmax_ruby_render_single_post_featured_layout_1' ) ) {
	function newsmax_ruby_render_single_post_featured_layout_1( $param = array() ) {
		...
		$class_name[] = 'is-single-' . esc_attr( $header_position );
		if ( is_sticky() ) {
			$class_name[] = 'is-sticky-single';
		}
