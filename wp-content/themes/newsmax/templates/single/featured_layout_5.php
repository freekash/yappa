 ...
 *
 * @return string
 * render single post featured layout 5
 */
if ( ! function_exists( 'newsmax_ruby_render_single_post_featured_layout_5' ) ) {
	function newsmax_ruby_render_single_post_featured_layout_5( $param = array() ) {
		...
		$class_name   = array();
		$class_name[] = 'single-post-wrap single-post-5 is-single-background is-single-' . esc_attr( $header_position );
		if ( ! empty( $parallax ) ) {
