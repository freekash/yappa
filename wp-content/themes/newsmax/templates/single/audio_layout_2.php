 ...
 *
 * @return string
 * render single post audio 2
 */
if ( ! function_exists( 'newsmax_ruby_render_single_post_audio_layout_2' ) ) {
	function newsmax_ruby_render_single_post_audio_layout_2( $param = array() ) {
		...
		$class_name       = 'single-post-wrap single-post-audio-2 single-post-1 is-single-' . esc_attr( $header_position );
