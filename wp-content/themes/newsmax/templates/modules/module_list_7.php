 ...
 *
 * @return string
 * newsmax_ruby_post_list_7
 */
if ( ! function_exists( 'newsmax_ruby_post_list_7' ) ) {
	function newsmax_ruby_post_list_7( $options = array() ) {

		$review = newsmax_ruby_post_review_icon();

		$class_name   = array();
		$class_name[] = 'post-wrap post-list post-list-3 post-list-7 clearfix';
		...
		$str .= newsmax_ruby_post_title( 'is-size-3' );
