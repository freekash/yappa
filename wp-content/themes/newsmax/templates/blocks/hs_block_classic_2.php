<?php
/**
 * Class newsmax_ruby_hs_block_classic_2
 */
if ( ! class_exists( 'newsmax_ruby_hs_block_classic_2' ) ) {
	class newsmax_ruby_hs_block_classic_2 extends newsmax_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'hs-block block-default hs-block-classic-2';
