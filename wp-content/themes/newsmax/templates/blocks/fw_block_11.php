<?php
/**
 * Class newsmax_ruby_fw_block_11
 */
if ( ! class_exists( 'newsmax_ruby_fw_block_11' ) ) {
	class newsmax_ruby_fw_block_11 extends newsmax_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes']                  = 'fw-block block-feat fw-block-11';
			$block['block_options']['no_found_rows'] = true;
			if ( ! empty( $block['block_options']['grid_style'] ) ) {
				$block['block_classes'] = 'fw-block block-feat fw-block-11 is-grid-style-' . esc_attr( $block['block_options']['grid_style'] );
			}
		...
		static function listing( $data_query, $options = array() ) {
			...
			$str = '';
			$str .= '<div class="fw-block-11-slider-outer">';
			$str .= '<div class="slider-loader"></div>';
			$str .= '<div class="fw-block-11-slider slider-init">';
