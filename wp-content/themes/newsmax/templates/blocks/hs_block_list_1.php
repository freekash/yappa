<?php
/**
 * Class newsmax_ruby_hs_block_list_1
 */
if ( ! class_exists( 'newsmax_ruby_hs_block_list_1' ) ) {
	class newsmax_ruby_hs_block_list_1 extends newsmax_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'hs-block block-list hs-block-list-1';
