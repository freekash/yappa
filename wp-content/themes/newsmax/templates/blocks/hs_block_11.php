...
/**
 * Class newsmax_ruby_hs_block_11
 */
if ( ! class_exists( 'newsmax_ruby_hs_block_11' ) ) {
	class newsmax_ruby_hs_block_11 extends newsmax_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'hs-block block-default hs-block-11';
