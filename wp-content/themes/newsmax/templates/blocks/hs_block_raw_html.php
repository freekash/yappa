<?php
/**
 * Class newsmax_ruby_hs_block_raw_html
 * render has fullwidth block custom html
 */
if ( ! class_exists( 'newsmax_ruby_hs_block_raw_html' ) ) {
	class newsmax_ruby_hs_block_raw_html extends newsmax_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'hs-block block-raw-html hs-block-raw-html';
