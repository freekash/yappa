<?php
/**
 * Class newsmax_ruby_hs_block_oneh_3
 */
if ( ! class_exists( 'newsmax_ruby_hs_block_oneh_3' ) ) {
	class newsmax_ruby_hs_block_oneh_3 extends newsmax_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'hs-block hs-block-oneh hs-block-oneh-3 col-sm-6 col-xs-12';
