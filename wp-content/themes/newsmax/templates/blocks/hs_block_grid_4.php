<?php
/**
 * Class newsmax_ruby_hs_block_grid_4
 */
if ( ! class_exists( 'newsmax_ruby_hs_block_grid_4' ) ) {
	class newsmax_ruby_hs_block_grid_4 extends newsmax_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'hs-block hs-block-grid hs-block-grid-4';
