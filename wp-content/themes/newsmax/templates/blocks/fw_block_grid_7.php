<?php
/**
 * Class newsmax_ruby_fw_block_grid_7
 */
if ( ! class_exists( 'newsmax_ruby_fw_block_grid_7' ) ) {
	class newsmax_ruby_fw_block_grid_7 extends newsmax_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'fw-block fw-block-grid-7';
			if ( ! empty( $block['block_options']['grid_style'] ) ) {
				$block['block_classes'] = 'fw-block fw-block-grid-7 is-grid-style-' . esc_attr( $block['block_options']['grid_style'] );
			}
