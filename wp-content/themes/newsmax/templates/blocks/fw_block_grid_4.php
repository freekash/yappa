<?php
/**
 * Class newsmax_ruby_fw_block_grid_4
 */
if ( ! class_exists( 'newsmax_ruby_fw_block_grid_4' ) ) {
	class newsmax_ruby_fw_block_grid_4 extends newsmax_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'fw-block fw-block-grid-4';
