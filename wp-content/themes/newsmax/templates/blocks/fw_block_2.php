<?php
/**
 * Class newsmax_ruby_fw_block_2
 */
if ( ! class_exists( 'newsmax_ruby_fw_block_2' ) ) {
	class newsmax_ruby_fw_block_2 extends newsmax_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes']                  = 'fw-block block-feat fw-block-2';
			$block['block_options']['no_found_rows'] = true;
			if ( ! empty( $block['block_options']['grid_style'] ) ) {
				$block['block_classes'] = 'fw-block block-feat fw-block-2 is-grid-style-' . esc_attr( $block['block_options']['grid_style'] );
			}
