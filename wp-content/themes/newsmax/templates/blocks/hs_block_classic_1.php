<?php
/**
 * Class newsmax_ruby_hs_block_classic_1
 */
if ( ! class_exists( 'newsmax_ruby_hs_block_classic_1' ) ) {
	class newsmax_ruby_hs_block_classic_1 extends newsmax_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'hs-block block-classic hs-block-classic-1';
