<?php
/**
 * Class newsmax_ruby_fw_block_grid_2
 */
if ( ! class_exists( 'newsmax_ruby_fw_block_grid_2' ) ) {
	class newsmax_ruby_fw_block_grid_2 extends newsmax_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'fw-block fw-block-grid-2';
		...
		static function listing( $data_query, $options = array() ) {
			...
			while ( $data_query->have_posts() ) {
				...
				$str .= newsmax_ruby_post_grid_1( $options );
				$str .= '</div><!--#post outer-->';
			}
