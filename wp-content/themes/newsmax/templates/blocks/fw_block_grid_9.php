<?php
/**
 * Class newsmax_ruby_fw_block_grid_9
 */
if ( ! class_exists( 'newsmax_ruby_fw_block_grid_9' ) ) {
	class newsmax_ruby_fw_block_grid_9 extends newsmax_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'fw-block fw-block-grid-9';

			if ( ! empty( $block['block_options']['grid_style'] ) ) {
				$block['block_classes'] = 'fw-block fw-block-grid-9 is-grid-style-' . esc_attr( $block['block_options']['grid_style'] );
			}
