<?php
/**
 * Class newsmax_ruby_hs_block_gallery_1 ( block grid slider)
 */
if ( ! class_exists( 'newsmax_ruby_hs_block_gallery_1' ) ) {
	class newsmax_ruby_hs_block_gallery_1 extends newsmax_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'hs-block hs-block-gallery hs-block-gallery-1';
