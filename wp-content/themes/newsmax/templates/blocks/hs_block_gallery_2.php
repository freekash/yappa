<?php
/**
 * Class newsmax_ruby_hs_block_gallery_2 ( block grid gallery slider)
 */
if ( ! class_exists( 'newsmax_ruby_hs_block_gallery_2' ) ) {
	class newsmax_ruby_hs_block_gallery_2 extends newsmax_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'hs-block hs-block-gallery hs-block-gallery-2';
