<?php
/**
 * Class newsmax_ruby_fw_block_onet_1
 */
if ( ! class_exists( 'newsmax_ruby_fw_block_onet_1' ) ) {
	class newsmax_ruby_fw_block_onet_1 extends newsmax_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'fw-block fw-block-onet fw-block-onet-1 col-sm-4 col-xs-12';
