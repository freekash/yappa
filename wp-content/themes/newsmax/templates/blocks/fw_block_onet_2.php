 ...
 */
if ( ! class_exists( 'newsmax_ruby_fw_block_onet_2' ) ) {
	class newsmax_ruby_fw_block_onet_2 extends newsmax_ruby_block {
		...
		static function render( $block ) {
			...
			$block['block_classes'] = 'fw-block fw-block-onet fw-block-onet-2 col-sm-4 col-xs-12';
