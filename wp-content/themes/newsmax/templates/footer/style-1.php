...
$newsmax_ruby_footer_class_name = 'footer-wrap footer-style-1 ' . esc_attr($newsmax_ruby_footer_text_style);
?>
...
<div id="ruby-footer" class="<?php echo esc_attr($newsmax_ruby_footer_class_name); ?>">
	...
	<div class="footer-inner">
		<?php if ( is_active_sidebar( 'newsmax_ruby_sidebar_footer_1' ) || is_active_sidebar( 'newsmax_ruby_sidebar_footer_2' ) || is_active_sidebar( 'newsmax_ruby_sidebar_footer_3' )) : ?>
